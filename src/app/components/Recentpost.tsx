...
export default function Recentpost(){
    return(
        <div className="bg-recentbackground mx-auto md:w-[1030px] md:h-[100%] my-[66px]
         md:flex flex-col justify-evevnly sm:w-[900px] sm:h-[100%] sm:flex flex-row">
         ...
         <Link href={""} className={`${heebo.className} text-[22px] font-medium text-mypink`}>View All</Link>
        </div>
